...
public class Group extends Client {
    ...
    public Group(String access_token, Integer last_ts) {
        super(access_token, last_ts);
    }

    public Group(Integer id, String access_token, Integer last_ts) {
        super(id, access_token, last_ts);
    }
