...
@Component
class MeetingTableNotUseState: State<MeetingTable> {

    override val state: EntityState<MeetingTable> = TableEntityState.NOT_USE
    ...
    override fun execute(context: MeetingTable): Optional<MeetingTable> {
        ...
        return context.copy(state = TableEntityState.NOT_USE).let(service::update).map {
